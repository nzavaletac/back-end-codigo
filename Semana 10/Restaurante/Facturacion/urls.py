...
from .views import ComandasView, CrearPedidoView, CustomPayloadView, MesasView, RegistroUsuarioView, crear_pedido, mesas_disponibles
...
urlpatterns = [
    ...
    path('crearPedido', crear_pedido),
    path('crearPedidoV', CrearPedidoView.as_view()),
]